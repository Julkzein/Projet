...
public class DecksUITest extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        */
        ...
        ObservableValue<String> text = new SimpleObjectProperty<>("Test text displayed");
        ...
        BorderPane root3Node = new BorderPane(decks);
        primaryStage.setScene(new Scene(root3Node));
