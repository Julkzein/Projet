package ch.epfl.chacun.testantoine.etape3;
...
class MyAreaTest {
    ...
    private final Set<Zone.Meadow> meadow = Set.of(
    ...
    private final Set<Zone.Forest> forest = new HashSet<>(Set.of(
    ...
    private final Set<Zone.River> river = new HashSet<>(Set.of(
    ...
    private final List<PlayerColor> occupants = List.of(PlayerColor.RED, PlayerColor.BLUE, PlayerColor.GREEN, PlayerColor.YELLOW);
    private final List<PlayerColor> occupants2 = List.of(PlayerColor.RED, PlayerColor.BLUE, PlayerColor.GREEN, PlayerColor.YELLOW, PlayerColor.PURPLE);
    private final Zone.Lake lake = new Zone.Lake(6, 23, Zone.SpecialPower.SHAMAN);
    private final Set<Zone.Water> waterSet = Set.of(
            new Zone.River(110, 2, lake),
            new Zone.River(131, 4, lake),
            new Zone.River(232, 13, new Zone.Lake(2, 10, Zone.SpecialPower.PIT_TRAP))
    );
    private final Set<Zone.Water> waterSet2 = Set.of(
    ...
    void riverSystemFishCountIsDefinedCorrectly() {
        ...
        assertEquals(19, Area.riverSystemFishCount(area));

        area = new Area<>(Set.of(new Zone.River(0, 2,  lake)), List.of(), 1);
        assertEquals(2, Area.riverSystemFishCount(area));

        area = new Area<>(Set.of(new Zone.River(0, 2,  lake), new Zone.River(1, 4,
                new Zone.Lake(1, 40, Zone.SpecialPower.LOGBOAT))), List.of(), 1);
        assertEquals(6, Area.riverSystemFishCount(area));
    }
