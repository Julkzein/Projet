package ch.epfl.chacun.testantoine.etape2;
...
class MyPlacedTileTest {
    ...
    void withOccupantIsCorrectlyDefined() {
        ...
        assertThrows(IllegalArgumentException.class, () -> placedTile.withOccupant(occupant));
        assertEquals(new PlacedTile(tile, PlayerColor.RED, Rotation.NONE, new Pos(0, 0), occupant), placedTile.withNoOccupant().withOccupant(occupant));
    }
