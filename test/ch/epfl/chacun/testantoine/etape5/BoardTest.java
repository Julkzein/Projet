package ch.epfl.chacun.testantoine.etape5;
...
class BoardTest {
    ...
    void occupantCount() {
        ...
        assertEquals(3, boardWithOccupants.occupantCount(PlayerColor.RED, Occupant.Kind.PAWN));
        ...
        assertEquals(0, boardWithOccupants.occupantCount(PlayerColor.GREEN, Occupant.Kind.PAWN));
        assertEquals(0, boardWithOccupants.withNewTile(placedTile73).occupantCount(PlayerColor.GREEN, Occupant.Kind.PAWN));
        assertEquals(1, boardWithOccupants.withNewTile(placedTile73).withOccupant(new Occupant(Occupant.Kind.PAWN, 733)).occupantCount(PlayerColor.GREEN, Occupant.Kind.PAWN));
        for (PlayerColor color : List.of(PlayerColor.YELLOW, PlayerColor.PURPLE)) {
    ...
    @Test
    void withNewTile() {
        // All the other methods indirectly test this method
    }


    @Test
    void withoutGatherersOrFishersIn() {
        Occupant occupant1 = new Occupant(Occupant.Kind.PAWN, 562);
        Occupant occupant2 = new Occupant(Occupant.Kind.PAWN, 176);
        Occupant occupant3 = new Occupant(Occupant.Kind.PAWN, 273);

        Board newBoard2 = board1.withNewTile(placedTile56).withNewTile(placedTile17).withNewTile(placedTile27)
                .withOccupant(occupant1).withOccupant(occupant2).withOccupant(occupant3);

        assertEquals(Set.of(occupant1, occupant2, occupant3), newBoard2.withoutGatherersOrFishersIn(Set.of(newBoard2.forestArea(forest1)), Set.of(newBoard2.riverArea(river5))).occupants());
    }

    @Test
    void withMoreCancelledAnimals() {
        assertNotEquals(board1, board1.withMoreCancelledAnimals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS))));
        assertNotEquals(board1.withNewTile(placedTile56), board1.withNewTile(placedTile56).withMoreCancelledAnimals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS))));
        assertEquals(Set.of(), board1.cancelledAnimals());
        assertEquals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS)), board1.withMoreCancelledAnimals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS))).cancelledAnimals());

        Board newBoard = Board.EMPTY.withMoreCancelledAnimals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS)));
        assertEquals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS)), newBoard.cancelledAnimals());
        assertEquals(newBoard.cancelledAnimals(), board1.withMoreCancelledAnimals(Set.of(new Animal(66, Animal.Kind.DEER), new Animal(20, Animal.Kind.AUROCHS))).cancelledAnimals());
    }
